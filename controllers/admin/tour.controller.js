...
module.exports.createPost = async (req, res) => {
  ...
  req.body.priceAdult = req.body.priceAdult ? parseFloat(req.body.priceAdult).toFixed(2) : 0
  req.body.priceChildren = req.body.priceChildren ? parseFloat(req.body.priceChildren).toFixed(2) : 0
  req.body.priceBaby = req.body.priceBaby ? parseFloat(req.body.priceBaby).toFixed(2) : 0
  req.body.priceNewAdult = req.body.priceNewAdult ? parseFloat(req.body.priceNewAdult).toFixed(2) : 0
  req.body.priceNewChildren = req.body.priceNewChildren ? parseFloat(req.body.priceNewChildren).toFixed(2) : 0
  req.body.priceNewBaby = req.body.priceNewBaby ? parseFloat(req.body.priceNewBaby).toFixed(2) : 0
